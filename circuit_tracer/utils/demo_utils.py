...
def get_unembed_vecs(model, token_ids: list[int]) -> list[torch.Tensor]:
    """Return the ``(d_model,)`` unembedding row of each token ID."""
    return [model.unembed_weight[tid] for tid in token_ids]
